...
date_published: 2021-05-03T14:37:15.000Z
date_updated: 2021-05-10T09:03:48.000Z
tags: iOS, Intune, MEM
excerpt: Welcome to part four of this series covering iOS/iPadOS management in Microsoft Endpoint Manger, this will be the last part in this series. So far, we've covered the basics of iOS/iPadOS in MDM, the different deployment methods available and how to configure devices as well as deploy apps.
---
...
[Managing *i*OS/iPadOS Part 2: Deployment methods](__GHOST_URL__/managing-ios-ipados-part-2-deployment-methods/)

[Managing iOS/iPadOS Part 3: Configurations & Apps](__GHOST_URL__/managing-ios-ipados-part-3/)
...
To integrate ABM with Azure AD, you first must verify your domain. We cover how to do this in [part two](__GHOST_URL__/managing-ios-ipados-part-2-deployment-methods).
...
![Screenshot-2021-05-10-at-10.53.29](__GHOST_URL__/content/images/2021/05/Screenshot-2021-05-10-at-10.53.29.png)
...
7. Click **Done**
![Screenshot-2021-05-10-at-10.55.46](__GHOST_URL__/content/images/2021/05/Screenshot-2021-05-10-at-10.55.46.png)

### Test authentication with a single Azure AD account

1. 
Click Federate next to the domain you want to federate.
![Screenshot-2021-05-10-at-10.55.04](__GHOST_URL__/content/images/2021/05/Screenshot-2021-05-10-at-10.55.04.png)
...
![Screenshot-2021-05-10-at-10.56.28](__GHOST_URL__/content/images/2021/05/Screenshot-2021-05-10-at-10.56.28.png)
![Screenshot-2021-05-10-at-10.56.44](__GHOST_URL__/content/images/2021/05/Screenshot-2021-05-10-at-10.56.44.png)
![Screenshot-2021-05-10-at-10.57.00](__GHOST_URL__/content/images/2021/05/Screenshot-2021-05-10-at-10.57.00.png)
...
![](__GHOST_URL__/content/images/wordpress/2020/04/appsso-1024x216.png)
...
![](__GHOST_URL__/content/images/2021/05/ssoextflow.gif)
# Wrapping up
