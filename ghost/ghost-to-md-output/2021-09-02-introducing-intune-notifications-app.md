...
date_published: 2021-09-02T14:43:15.000Z
date_updated: 2023-06-10T07:25:24.000Z
tags: Power Automate, Power Apps, Tools
excerpt: Throughout the years of managing devices in MDM it has been interesting to keep track of all tokens and certificates we use to connect to Apple Business Manager (ABM), Apple Push Notification Server (APNs), Managed Google Play etc.
---
...
![](__GHOST_URL__/content/images/2021/09/HomeScreen-1.JPEG)

![](__GHOST_URL__/content/images/2021/09/ABMScreen.JPEG)

![](__GHOST_URL__/content/images/2021/09/VPPScreen.PNG)

![](__GHOST_URL__/content/images/2021/09/GPlayScreen.PNG)
...
![](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-13.29.59.png)
To get the details and status of all services, a flow per service is run that collects all the information.
![](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-10.26.25.png)
To send a push notification if any issues are detected, a recurring flow is setup
![](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-13.31.34.png)
**How can I use this? **
...
![Screenshot-2021-09-02-at-11.49.48](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-11.49.48.png)
...
![Screenshot-2021-09-02-at-11.45.08](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-11.45.08.png)
...
![Screenshot-2021-09-02-at-11.48.05](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-11.48.05.png)
...
![Screenshot-2021-09-02-at-14.12.28](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-14.12.28.png)
...
![Screenshot-2021-09-02-at-14.19.27](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-14.19.27.png)
...
![Screenshot-2021-09-02-at-14.30.03](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-14.30.03.png)
...
![Screenshot-2021-09-02-at-14.33.42](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-14.33.42.png)
- When the above edits has been made, turn on each flow by clicking the three dots and then click **Turn on**
![Screenshot-2021-09-02-at-14.36.32](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-14.36.32.png)
...
![Screenshot-2021-09-02-at-15.11.21](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-15.11.21.png)
- Click **Create New**
![Screenshot-2021-09-02-at-15.15.07](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-15.15.07.png)
- Click **Create a connection**, choose **Power Apps Push Notification V2** and click **Create**
![Screenshot-2021-09-02-at-15.21.27](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-15.21.27.png)
- Navigate back to the import tab, now you will have a connection, click **Power Apps Push Notification V2** then click **Save**
![Screenshot-2021-09-02-at-15.23.15](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-15.23.15.png)
- Click **Import**
...
![Screenshot-2021-09-02-at-15.00.59](__GHOST_URL__/content/images/2021/09/Screenshot-2021-09-02-at-15.00.59.png)
- Save the flow
