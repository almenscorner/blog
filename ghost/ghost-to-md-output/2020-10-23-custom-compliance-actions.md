...
date_published: 2020-10-23T16:46:38.000Z
date_updated: 2021-02-22T15:49:33.000Z
tags: Compliance, Graph API, MEM, Powershell
---
...
![](__GHOST_URL__/content/images/wordpress/2020/10/group1-1024x766.png)
- Give the group a name and click **Create**

![](__GHOST_URL__/content/images/wordpress/2020/10/group2.png)
- Search for the group and copy the ID and save it for later

![](__GHOST_URL__/content/images/wordpress/2020/10/group3.png)
...
![](__GHOST_URL__/content/images/wordpress/2020/10/assign3-1024x564.png)
...
![](__GHOST_URL__/content/images/wordpress/2020/10/comp1-1024x536.png)
- Give the policy a name and click on **Next**

![](__GHOST_URL__/content/images/wordpress/2020/10/comp2.png)
- Expand **Device Properties** and provide maximum OS, in my case, 12.0. Then click **Next**

![](__GHOST_URL__/content/images/wordpress/2020/10/comp3_2-666x1024.png)
- Make sure Mark device noncompliant -> immediately is configured then click **Next**

![](__GHOST_URL__/content/images/wordpress/2020/10/comp4-706x1024.png)
- Assign the policy to a group that your test user is a member of, in my case EMS-Users then click **next**

![](__GHOST_URL__/content/images/wordpress/2020/10/comp5-633x1024.png)
- Review the configured settings and then click **Create**

![](__GHOST_URL__/content/images/wordpress/2020/10/comp6-671x1024.png)
- Copy the policy ID from your browser and save it for later

![](__GHOST_URL__/content/images/wordpress/2020/10/comp7-1024x104.png)
...
![](__GHOST_URL__/content/images/wordpress/2020/10/add.png)
