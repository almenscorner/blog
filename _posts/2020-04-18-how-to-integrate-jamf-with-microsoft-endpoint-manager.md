...
date_published: 2020-04-17 22:47:16.000000000 Z
date_updated: 2020-04-20 10:49:26.000000000 Z
tags:
- azure ad
- conditional access
- jamf
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/image-311-1024x592-1.png)
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/jamf-848x1024.png)
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/appreg1-1024x885.png)

---

- Give the app a name, for example Jamf Pro CA, choose **Accounts in any organizational directory** and then click on **Register**.

![]({{ site.baseurl }}/assets/images/wordpress/2020/04/appreg2-1024x856.png)
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/appreg3-1024x678.png)
---

- Next, click on **API permissions -> Add a permission** and select **Intune** and then **Application permissions**.

![]({{ site.baseurl }}/assets/images/wordpress/2020/04/appreg4-1024x597.png)
---

- Select **update_device_attributes** and then click on **Add permissions**.

![]({{ site.baseurl }}/assets/images/wordpress/2020/04/appreg5.png)
---
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/appreg6-1024x391.png)
---
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/mem1.png)
---
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/mem2-1024x864.png)
---
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/jamf1-1024x574.png)
---
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/jamf2-1024x726.png)
---
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/jamf3.png)
...
![]({{ site.baseurl }}/assets/images/wordpress/2020/04/45121078_332697134163303_2872554009661538304_o-1024x371.jpg)
