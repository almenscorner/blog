...
---
In the last couple of posts where we have used Azure DevOps Pipelines to add new packages for macOS
and move them between catalogs, you were able to setup an incoming Teams webhook to get notified when something happens.
