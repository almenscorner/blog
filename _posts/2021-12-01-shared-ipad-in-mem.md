...
- Since we are signin in with Managed Apple IDs, your ABM should be federated with Azure AD. I have previously written about this, you can [find this post here]({% post_url 2021-05-03-managing-ios-ipados-part-4-identity %}#federated-authentication).
