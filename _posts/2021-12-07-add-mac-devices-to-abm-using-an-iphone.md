...
date_published: 2021-12-07 15:33:46.000000000 Z
date_updated: 2021-12-07 15:33:46.000000000 Z
tags:
- abm
- macos
excerpt: Since iOS 11 we have been able to add iOS devices to Apple Business Manager
  using Apple Configurator 2 on a macOS device by connecting the device to the mac.
  Ever since this became available, most of us have wanted this feature for mac devices
  as well.
---
...
![appstore-1]({{ site.baseurl }}/assets/images/2021/12/appstore-1.jpeg)
...
![acsignin]({{ site.baseurl }}/assets/images/2021/12/acsignin.jpeg)
- Grant access to the camera
![accamera]({{ site.baseurl }}/assets/images/2021/12/accamera.jpeg)
...
![acsettings]({{ site.baseurl }}/assets/images/2021/12/acsettings.jpeg)
...
![acscan]({{ site.baseurl }}/assets/images/2021/12/acscan.jpeg)
...
![acdevicestatus]({{ site.baseurl }}/assets/images/2021/12/acdevicestatus.jpeg)
...
![abmservers]({{ site.baseurl }}/assets/images/2021/12/abmservers.png)
- Click on **Show devices**
![abmshowdevices]({{ site.baseurl }}/assets/images/2021/12/abmshowdevices.png)
- Click your device and then click **Edit Device Management**
![abmedit]({{ site.baseurl }}/assets/images/2021/12/abmedit.png)
- Choose your **MDM server** and click **Continue**
![abmassign]({{ site.baseurl }}/assets/images/2021/12/abmassign.png)
