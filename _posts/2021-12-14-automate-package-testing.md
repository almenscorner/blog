...
date_published: 2021-12-14 16:02:54.000000000 Z
date_updated: 2021-12-14 16:02:54.000000000 Z
tags:
- azure devops
- macos
- mem
- munki
- python
excerpt: In the last post related to Munki, I promised we were going to look at auto
  promoting packages between catalogs to automate a ring type structure to use for
  package testing and validation. And today is the day!
---
...
- [Deploy Munki with Microsoft Endpoint Manager]({% post_url 2021-08-25-integrate-munki-with-microsoft-endpoint-manager %})
- [Munki, what about manifests?]({% post_url 2021-09-24-munki-what-about-manifests %})
- [Azure DevOps with Pipeline for Azure Storage Munki repo]({% post_url 2021-10-05-azure-devops-with-pipeline-for-azure-storage-munki-repo %})
- [Automate app packaging, updating and distribution with Azure DevOps, AutoPkg and Munki]({% post_url 2021-10-19-automate-app-packaging-updating-and-distribution %})
...
**Munki manifests**
![]({{ site.baseurl }}/assets/images/2021/12/manifests.png)
...
![]({{ site.baseurl }}/assets/images/2021/10/Screenshot-2021-10-18-at-20.29.40.png)
...
- 
Click **View**
![pipelineview]({{ site.baseurl }}/assets/images/2021/12/pipelineview.png)

- 
Click **Permit** and then **Permit** again
![]({{ site.baseurl }}/assets/images/2021/12/pipelinepermit.png)
![]({{ site.baseurl }}/assets/images/2021/12/pipelinepermit2.png)
...
![]({{ site.baseurl }}/assets/images/2021/12/Screenshot-2021-12-13-at-14.16.31.png)
...
![]({{ site.baseurl }}/assets/images/2021/12/Screenshot-2021-12-14-at-15.25.21.png)
...
![autopkg-3]({{ site.baseurl }}/assets/images/2021/12/autopkg-3.png)
