...
date_published: 2021-02-25 15:10:35.000000000 Z
date_updated: 2021-02-25 17:00:32.000000000 Z
tags:
- azuread
- mfa
- security
...
![]({{ site.baseurl }}/assets/images/wordpress/2021/02/yubikey-1.jpg)
...
![]({{ site.baseurl }}/assets/images/wordpress/2021/02/fi1-1024x295.png)
...
![]({{ site.baseurl }}/assets/images/wordpress/2021/02/fi2-1024x300.png)
3. Click on **Add Method**, then choose **Security Key** and then **Add**
![]({{ site.baseurl }}/assets/images/wordpress/2021/02/fi3-1024x467.png)
...
![]({{ site.baseurl }}/assets/images/wordpress/2021/02/fi5.png)
...
![]({{ site.baseurl }}/assets/images/wordpress/2021/02/fi6.png)
3. Enter your pin-code and then touch the key

- ![]({{ site.baseurl }}/assets/images/wordpress/2021/02/fi7-1.png)
- ![]({{ site.baseurl }}/assets/images/wordpress/2021/02/fi8.png)

4. Voilá, we&#8217;re signed in

![]({{ site.baseurl }}/assets/images/wordpress/2021/02/fi9.png)
## Known issues
